...
from app.models import (
    User, UserRole, OTPCode, ParentChild,
    Subject, Product, Bundle,
    Order, OrderItem, UserLibrary, PromoCode,
    Timetable, TimetableProgress,
    TutorSubscription, ChatSession, ChatMessage,
    School, SchoolAdmin, SchoolOrder, SchoolLicense,
)
